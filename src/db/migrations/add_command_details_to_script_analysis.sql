...
ALTER TABLE script_analysis ADD COLUMN IF NOT EXISTS command_details JSONB DEFAULT '[]'::jsonb;
ALTER TABLE script_analysis ADD COLUMN IF NOT EXISTS ms_docs_references JSONB DEFAULT '[]'::jsonb;
